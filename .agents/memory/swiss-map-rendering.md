...
- City markers sit above canton paths, so they must trigger the same canton-selection flow and remain keyboard operable. Otherwise they create dead zones over the map.
