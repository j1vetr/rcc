...
export const assistantCopy: Record<Language, AssistantCopy> = {
  de: {
    ...
    items: [
      ...
      { id: 7, category: 'process', question: 'In welchen Regionen sind Sie verfügbar?', answer: 'Wir sind vorwiegend im Kanton Zürich und Umgebung tätig. Nennen Sie uns Ihre Adresse oder Postleitzahl — wir bestätigen die Verfügbarkeit für Ihren Standort.' },
  ...
  fr: {
    ...
    items: [
      ...
      { id: 7, category: 'process', question: 'Dans quelles régions intervenez-vous ?', answer: 'Nous intervenons principalement dans le canton de Zurich et ses environs. Indiquez votre adresse ou code postal — nous confirmons la disponibilité pour votre emplacement.' },
