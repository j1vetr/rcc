...
const CONFIGS: Record<Lang, Omit<ServiceConfig, 'packagesRouteKey' | 'featuresLang'>> = {
  de: {
    ...
    faqs: [
      ...
      { question: 'In welchen Regionen der Schweiz ist RCC tätig?', answer: 'RCC ist in der ganzen Schweiz im Einsatz. Bitte nehmen Sie Kontakt auf oder nutzen Sie das Offertformular, damit wir Ihren Standort bestätigen können.' },
  ...
  en: {
    ...
    lead: 'RCC brings the full professional cleaning equipment directly to your vehicle — at home, at work or anywhere across Switzerland. No driving, no time lost.',
    coverage: [
    ...
    faqs: [
      ...
      { question: 'Which regions of Switzerland does RCC serve?', answer: 'RCC operates across Switzerland. Please contact us or use the quote form so we can confirm your exact location.' },
  ...
  fr: {
    ...
    faqs: [
      ...
      { question: 'Quelles régions de la Suisse RCC dessert-il ?', answer: 'RCC intervient dans toute la Suisse. Contactez-nous ou utilisez le formulaire de devis pour que nous puissions confirmer votre emplacement exact.' },
