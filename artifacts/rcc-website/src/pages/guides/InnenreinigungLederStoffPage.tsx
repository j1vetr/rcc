...
const CONFIG: GuidePageConfig = {
  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        'Für die Reinigung von Ledersitzen verwenden Profis pH-neutrale Lederpfleger, die das Material nicht angreifen. Ein feuchtes Tuch genügt für leichte Verschmutzungen. Eingetrocknete Flecken erfordern mehr Geduld und den richtigen Reiniger. Haushaltsmittel wie Spülmittel oder Scheuermittel sind nicht geeignet.',
      ],
    },
    {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: 'Ja. RCC reinigt Innenräume mit Leder- und Stoffpolstern und verwendet je nach Material geeignete Mittel. Anfrage über das Formular auf der Website oder per Telefon/WhatsApp.',
    },
  ],
  internalLinks: [
