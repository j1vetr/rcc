          ...
          <div className="max-w-3xl md:max-w-2xl text-left">
            ...
            >
              ...
              <button
                ...
                className="min-h-12 px-6 py-3.5 border border-white/25 bg-black/45 backdrop-blur-md text-xs sm:text-sm font-semibold uppercase tracking-[0.13em] text-white flex items-center justify-center gap-2.5 hover:bg-[#25D366] hover:border-[#25D366] hover:text-black transition-all"
              >
