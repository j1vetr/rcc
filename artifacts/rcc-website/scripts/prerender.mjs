...
const ROUTES = [
  ...
  // ── City landing pages ──
  { url: '/de/mobile-autoreinigung/winterthur/',          lang: 'de-CH', routeKey: 'mobile-autoreinigung/winterthur' },
  { url: '/en/mobile-car-cleaning/winterthur/',           lang: 'en-CH', routeKey: 'mobile-autoreinigung/winterthur' },
  { url: '/de/mobile-autoreinigung/zug/',                 lang: 'de-CH', routeKey: 'mobile-autoreinigung/zug' },
  { url: '/en/mobile-car-cleaning/zug/',                  lang: 'en-CH', routeKey: 'mobile-autoreinigung/zug' },
  { url: '/de/mobile-autoreinigung/luzern/',              lang: 'de-CH', routeKey: 'mobile-autoreinigung/luzern' },
  { url: '/en/mobile-car-cleaning/lucerne/',              lang: 'en-CH', routeKey: 'mobile-autoreinigung/luzern' },
  { url: '/de/mobile-autoreinigung/basel/',               lang: 'de-CH', routeKey: 'mobile-autoreinigung/basel' },
  { url: '/en/mobile-car-cleaning/basel/',                lang: 'en-CH', routeKey: 'mobile-autoreinigung/basel' },
  { url: '/de/mobile-autoreinigung/bern/',                lang: 'de-CH', routeKey: 'mobile-autoreinigung/bern' },
  { url: '/en/mobile-car-cleaning/bern/',                 lang: 'en-CH', routeKey: 'mobile-autoreinigung/bern' },
  { url: '/de/mobile-autoreinigung/st-gallen/',           lang: 'de-CH', routeKey: 'mobile-autoreinigung/st-gallen' },
  { url: '/fr/nettoyage-voiture-mobile/geneve/',          lang: 'fr-CH', routeKey: 'mobile-autoreinigung/geneve' },
  { url: '/en/mobile-car-cleaning/geneva/',               lang: 'en-CH', routeKey: 'mobile-autoreinigung/geneve' },
  { url: '/fr/nettoyage-voiture-mobile/lausanne/',        lang: 'fr-CH', routeKey: 'mobile-autoreinigung/lausanne' },
  { url: '/en/mobile-car-cleaning/lausanne/',             lang: 'en-CH', routeKey: 'mobile-autoreinigung/lausanne' },
...
const ROUTE_CLUSTERS = [
  ...
  ['/de/mobile-autoreinigung/winterthur/', '/en/mobile-car-cleaning/winterthur/'],
  ['/de/mobile-autoreinigung/zug/', '/en/mobile-car-cleaning/zug/'],
  ['/de/mobile-autoreinigung/luzern/', '/en/mobile-car-cleaning/lucerne/'],
  ['/de/mobile-autoreinigung/basel/', '/en/mobile-car-cleaning/basel/'],
  ['/de/mobile-autoreinigung/bern/', '/en/mobile-car-cleaning/bern/'],
  ['/de/mobile-autoreinigung/st-gallen/'],
  ['/fr/nettoyage-voiture-mobile/geneve/', '/en/mobile-car-cleaning/geneva/'],
  ['/fr/nettoyage-voiture-mobile/lausanne/', '/en/mobile-car-cleaning/lausanne/'],
